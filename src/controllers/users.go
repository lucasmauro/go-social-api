...
func ChangePassword(w http.ResponseWriter, r *http.Request) {
	...
	if authenticatedUserID != userID {
		responses.Error(w, http.StatusForbidden, errors.New("You may not change another user's password"))
		return
	}
	...
	repository := repositories.NewUserRepository(db)
	currentPassword, err := repository.GetUserPassword(userID)
	if err != nil {
		responses.Error(w, http.StatusInternalServerError, err)
		return
	}

	if err = security.VerifyPassword(password.Current, currentPassword); err != nil {
		responses.Error(w, http.StatusInternalServerError, errors.New("Your current password does not match"))
		return
	}
